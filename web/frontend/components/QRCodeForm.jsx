...
const NO_DISCOUNT_OPTION = { label: "Pas de réduction", value: "" };
      ...
      <Layout>
        <Layout.Section>
          <Form>
            ...
            />
            <FormLayout>
              <Card sectioned title="Titre">
                <TextField
                  {...title}
                  label="Titre"
                  labelHidden
                  helpText="Ne sera pas visible par le client"
                />
              </Card>
              ...
              >
                ...
                <Card.Section title="Destination du QR code">
                  <ChoiceList
                    title="Scan destination"
                    titleHidden
                    choices={[
                      { label: "Page produit", value: "product" },
                      {
                        label: "Page paiement avec le produit dans le panier",
                        value: "checkout",
                      },
                    ]}
        ...
        <Layout.Section secondary>
          <Card sectioned title="QR code">
            {QRCode ? (
              ...
              <EmptyState>
                <p>Votre QR code apparaitra ici après sa création</p>
              </EmptyState>
            )}
            <Stack vertical>
              <Button
